...
namespace WinFormsCoreDockPanelSuite.ThemeVS2003
{
    ...
    public class VS2003Theme : ThemeBase
    {
        public VS2003Theme()
        {
            ...
            Extender.AutoHideWindowFactory = new VS2003AutoHideWindowFactory();
            ...
            Extender.DockPaneSplitterControlFactory = new VS2003DockPaneSplitterControlFactory();
            Extender.WindowSplitterControlFactory = new VS2003WindowSplitterControlFactory();
            Extender.DockWindowFactory = new VS2003DockWindowFactory();
            Extender.PaneIndicatorFactory = new VS2003PaneIndicatorFactory();
            Extender.PanelIndicatorFactory = new VS2003PanelIndicatorFactory();
            Extender.DockOutlineFactory = new VS2003DockOutlineFactory();
            Extender.DockIndicatorFactory = new VS2003DockIndicatorFactory();
        }

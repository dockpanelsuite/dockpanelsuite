...
namespace WinFormsCoreDockPanelSuite.ThemeVS2015
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    internal class VS2015_2012DockWindow : DockWindow
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VS2015_2012DockWindow"/> class.
        /// </summary>
        /// <param name="dockPanel">The dock panel.</param>
        /// <param name="dockState">State of the dock.</param>
        public VS2015_2012DockWindow(DockPanel dockPanel, DockState dockState) : base(dockPanel, dockState)
        {
        }

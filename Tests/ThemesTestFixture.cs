...
namespace Tests
{
    ...
    public class ThemesTestFixture
    {
        ...
        #region VS2017
        [Test]
        public void CreateVisualStudio2017Blue()
        {
            var ColorPalette = new VS2017BlueTheme().ColorPalette;
        ...
        [Test]
        public void CreateVisualStudio2017Dark()
        {
            var ColorPalette = new VS2017DarkTheme().ColorPalette;
        ...
        [Test]
        public void CreateVisualStudio2017Light()
        {
            var ColorPalette = new VS2017LightTheme().ColorPalette;

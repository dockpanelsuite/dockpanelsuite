...
namespace WeifenLuo.WinFormsUI.ThemeVS2010
{
    ...
    {
        private class TabVS2010 : Tab
        {
            public TabVS2010(IDockContent content)
                : base(content)
            {
            }
        ...
        {
            get { return VS2010AutoHideStrip.GraphicsPath; }
        }
        ...
        private bool CalculateDocumentTab(Rectangle rectTabStrip, ref int x, int index)
        {
            ...
            var tab = Tabs[index] as TabVS2010;
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                int tempX = x;
                var tab = Tabs[m_startDisplayingTab] as TabVS2010;
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    tabActive = Tabs[i] as TabVS2010;
                    continue;
                }
                if (rectTab.IntersectsWith(rectTabOnly))
                    DrawTab(g, Tabs[i] as TabVS2010, rectTab, false);
            }
        ...
        private void DrawTabStrip_ToolWindow(Graphics g)
        {
            for (int i = 0; i < Tabs.Count; i++)
                DrawTab(g, Tabs[i] as TabVS2010, GetTabRectangle(i), i == Tabs.Count - 1);
        }
        ...
        private Rectangle GetTabRectangle_ToolWindow(int index)
        {
            ...
            TabVS2010 tab = (TabVS2010)(Tabs[index]);

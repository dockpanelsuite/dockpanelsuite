...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public class VS2012LightTheme : ThemeBase
    {
        ...
        public DockPanelSkin CreateVisualStudio2012Light()
        {
            var skin = new DockPanelSkin();

            ColorPalette.AutoHideStripDefault.Background = ColorTranslator.FromHtml("#FFEFEFF2");
            ...
            ColorPalette.AutoHideStripHovered.Background = ColorTranslator.FromHtml("#FFEFEFF2");
            ...
            ColorPalette.OverflowButtonHovered.Background = ColorTranslator.FromHtml("#FFFEFEFE");
            ColorPalette.OverflowButtonHovered.Border = ColorTranslator.FromHtml("#FFFEFEFE");
            ...
            ColorPalette.ToolWindowCaptionInactive.Background = ColorTranslator.FromHtml("#FFEFEFF2");
            ...
            ColorPalette.ToolWindowTabSelectedActive.Background = ColorTranslator.FromHtml("#FFF6F6F6");
            ColorPalette.ToolWindowTabSelectedActive.Separator = ColorTranslator.FromHtml("#FFCCCEDB");
            ColorPalette.ToolWindowTabSelectedActive.Text = ColorTranslator.FromHtml("#FF0E70C0");

            ColorPalette.ToolWindowTabSelectedInactive.Background = ColorTranslator.FromHtml("#FFF6F6F6");
            ColorPalette.ToolWindowTabSelectedInactive.Separator = ColorTranslator.FromHtml("#FFCCCEDB");
            ColorPalette.ToolWindowTabSelectedInactive.Text = ColorTranslator.FromHtml("#FF0E70C0");

            ColorPalette.ToolWindowTabUnselected.Separator = ColorTranslator.FromHtml("#FFCCCEDB");
            ColorPalette.ToolWindowTabUnselected.Text = ColorTranslator.FromHtml("#FF444444");

            ColorPalette.ToolWindowTabUnselectedHovered.Background = ColorTranslator.FromHtml("#FFFEFEFE");
            ColorPalette.ToolWindowTabUnselectedHovered.Separator = ColorTranslator.FromHtml("#FFCCCEDB");
            ColorPalette.ToolWindowTabUnselectedHovered.Text = ColorTranslator.FromHtml("#FF007ACC");

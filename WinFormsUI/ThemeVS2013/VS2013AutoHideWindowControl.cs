...
{
    internal class VS2013AutoHideWindowControl : DockPanel.AutoHideWindowControl
    {
        public VS2013AutoHideWindowControl(DockPanel dockPanel) : base(dockPanel)
        {
            m_splitter = new VS2013WindowSplitterControl(this);

    ...
    public class ImageService : IImageService
    {
        ...
        public ImageService(ThemeBase theme)
        {
            ...
            var bottom = ImageServiceHelper.GetDockIcon(
                ...
                ThemeVS2012.Resources.MaskCoreBottom,
                layerCore,
                separator);
            var center = ImageServiceHelper.GetDockIcon(
                ...
                background,
                theme.PaintingService,
                ThemeVS2012.Resources.MaskCoreCenter,
                layerCore,
                separator);
            var left = ImageServiceHelper.GetDockIcon(
                ...
                background,
                theme.PaintingService,
                ThemeVS2012.Resources.MaskCoreLeft,
                layerCore,
                separator);
            var right = ImageServiceHelper.GetDockIcon(
                ...
                background,
                theme.PaintingService,
                ThemeVS2012.Resources.MaskCoreRight,
                layerCore,
                separator);
            var top = ImageServiceHelper.GetDockIcon(
                ...
                background,
                theme.PaintingService,
                ThemeVS2012.Resources.MaskCoreTop,
                layerCore,
                separator);
